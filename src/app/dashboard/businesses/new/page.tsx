...
export default function NewBusinessPage() {
  ...
  return (
    <div className="p-6 max-w-2xl">
      ...
      {error && (
        <div className="mb-5 flex items-start gap-3 rounded-r-lg border-l-4 border-red-500 bg-red-50 px-4 py-3">
          <svg
      ...
      <form onSubmit={onSubmit} className="space-y-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xs font-semibold uppercase tracking-wider text-slate-500">Media</h2>
          <Input
            label="Logo URL"
            type="url"
            placeholder="https://..."
        ...
        <div className="flex gap-3 pt-2">
          <Button type="submit" isLoading={isLoading} disabled={isDisabled} className="flex-1">
